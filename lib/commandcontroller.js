...
CommandController = (function() {
  ...
  CommandController.prototype.checkPreRun = function(done) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      cmd = _ref[_i];
      _results.push(cmd.preRun(function(really) {
        var allDone, depCommand, idx, target, targets, _j, _k, _len1, _len2, _ref1;
        if (cmd.done) {
          idx = _this.running.indexOf(cmd);
          _this.pending.splice(idx, 1);
          _this.done.push(cmd);
          _this.info(cmd, "skipped (prerun)");
          _ref1 = cmd.dependencies;
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            ...
            allDone = true;
            targets = _this.getTargets(depCommand);
            ...
            if (allDone) {
              ...
              idx = _this.running.indexOf(depCommand);
              _this.pending.splice(idx, 1);
              _this.done.push(depCommand);
              _this.info(depCommand, "skipped (no target)");
            }
          }
        }
        all.push(cmd);
