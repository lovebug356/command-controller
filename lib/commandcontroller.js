  ...
  CommandController.prototype.run = function(done) {
    ...
    if (this.pending.length > 0) {
      ...
      if (this.running.length === 0) {
        console.log(("[" + this.done.length + "/" + (this.size()) + "] all done").green);
        return done();
      }
    }
  };
